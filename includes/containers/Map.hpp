...
namespace ft
{
	...
	private: //typedefs
		...
		typedef ft::redblacktree<value_type, allocator_type, value_compare>	tree_type;

	public:

		typedef ft::bidirectional_iterator<value_type, value_compare, Alloc>	iterator;
		typedef ft::bidirectional_iterator<value_type, value_compare, Alloc>	const_iterator;
	...
	public:
		...
		// iterators
		iterator									begin() {return iterator(_tree.findSmallest()->data, &_tree);} //done
		const_iterator								begin() const {return const_iterator(_tree.findSmallest()->data, &_tree);} //done
		...
		iterator									find(const Key& key) {return iterator(_tree.find(ft::make_pair(key, mapped_type()))->data, &_tree);} //done
		const_iterator								find(const Key& key) const {return const_iterator(_tree.find(ft::make_pair(key, mapped_type()))->data, &_tree);} //done
		...
		iterator									lower_bound(const Key& key) {return iterator(_tree.lower_bound(ft::make_pair(key, mapped_type()))->data, &_tree);} //done
		const_iterator								lower_bound(const Key& key) const {return const_iterator(_tree.lower_bound(ft::make_pair(key, mapped_type()))->data, &_tree);} //done
		iterator									upper_bound(const Key& key) {return iterator(_tree.upper_bound(ft::make_pair(key, mapped_type()))->data, &_tree);} //done
		const_iterator								upper_bound(const Key& key) const {return const_iterator(_tree.upper_bound(ft::make_pair(key, mapped_type()))->data, &_tree);} //done
