...
namespace ft
{
	...
	public:
		...
		explicit				stack(size_type count, const T& value = T(), const Allocator& alloc = Allocator())
		...
		template <class InputIt>	stack(InputIt first, InputIt last, const Allocator& alloc = Allocator(),
...
void swap(ft::stack<T, Allocator>& lhs, ft::stack<T,Allocator>& rhs ) {lhs.swap(rhs);} //done
